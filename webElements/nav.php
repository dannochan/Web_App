...
if(!$_SESSION['userid']) { echo '<style>div.bar.d-none.d-lg-block {display: none !important;}</style>'; }
...
<button data-bs-toggle="tooltip" title="Dashboard" class="btn btn-light<?php if($page == "dashboard") echo "_active"; ?>" onclick="location.href = 'dashboard.php'" type="button">
  ...
  <button data-bs-toggle="tooltip" title="Postfach" class="btn btn-light<?php if($page == "inbox") echo "_active"; ?>" onclick="location.href = 'inbox.php'" type="button">
