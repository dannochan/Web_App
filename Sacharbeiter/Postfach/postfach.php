        ...
        <div class="row m-1">
          <div class="col col-sm-2 py-2 bg-secondary text-dark bg-opacity-25" style="height:540px; ">
            <ul class="list-group list-group-flush bg-transparent">
              <li class="list-group-item list-group-item-action bg-transparent active"><a class="nav-link active m-0 p-0" href="postfach.php">Posteingang</a></li>
              <li class="list-group-item list-group-item-action bg-transparent nav-item"><a href="sentMsg.php">Gesendte</a></li>
              <li class="list-group-item list-group-item-action bg-transparent nav-item"><a href="deleteMsg.php">Gelöschte</a> </li>
            </ul>
          </div>
              ...
              WHERE Receiver = ?";
                    ...
                    ?>
                              <tr <?php if ($row['isNew'] == 1) {
                                ...
                                <td>
                                  <button class="btn btn-primary btn-sm openBtn" type="submit" id="openBtn" name="openBtn">
                                    <a href="offeneMsg.php?MessageID=<?php echo $row['MessageID']; ?>">Öffnen</a></button>
                                  <button class="btn btn-danger btn-sm deleteBtn" type="submit" id="deleteBtn" name="deleteBtn">
                                    <a href="msgLoesch.php?MessageID=<?php echo $row['MessageID']; ?>">Löschen</a></button>
                                </td>
                              </tr>
                    <?php endif;
                          endwhile;
                        ...
                        throw new Exception("Es ist etwas mit dem Login schiefgelaufen");
                      }
                    } catch (Exception $ex) {
